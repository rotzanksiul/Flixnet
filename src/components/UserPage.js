        ...
        <div className="user-page">
            <div className="user-page-header header" style={{height: "100vh"}}>
                ...
                <p className='p-base' style={{fontSize: "1.5rem"}}>You are Awesome!!.</p>
                    ...
                    <p className='p-base' style={{fontSize: "1.5rem"}}>If you liked my project please check my <a target='blank' className='base-link' href="https://hernluis.com/">Portfolio</a> to see more of my creations.</p>  
                </div>
            </div>
        </div>
    );
